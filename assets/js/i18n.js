...
export const STRINGS = {
  ...
  en: {
    ...
    tipFull: 'Full screen', tipFullExit: 'Exit full screen',
    ...
    tipTilt: 'Top view (R)', tipFront: 'Front view (F)', tipView: 'Default view (H)',
